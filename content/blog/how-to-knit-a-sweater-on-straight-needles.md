...
| :--- | :--- |
| **Yarn** | Worsted-weight (Medium #4) acrylic, wool, or wool-blend. Check your **knitting pattern** for exact yardage. |
| **Straight Needles** | US size 8 (5mm) or size recommended for your yarn. A pair of spares is helpful for sleeve knitting. |
| **Other Needles** | A set of double-pointed needles (DPNs) or a long circular needle for the neckband. |
| **Notions** | Scissors, a tapestry needle, stitch markers, a tape measure, and stitch holders or spare yarn. |
